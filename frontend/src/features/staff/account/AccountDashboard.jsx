import { useSearchStudent } from "../../../hooks/accountHooks/useSearchStudent";
...
export default function AccountDashboard(){
    ...
    const {data,isLoading, error} = useSearchStudent(values,{enabled: false});
...
<div className="card-body">
    ...
    {data && enabled && <ListStudent students={data}/>} 
</div>
</div>
</div>
</div>
